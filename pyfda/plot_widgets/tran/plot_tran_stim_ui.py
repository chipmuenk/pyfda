...
# ------------------------------------------------------------------------------
    ...
    def _construct_ui(self) -> None:
        ...
        self.led_tw_1.setText(str(self.tw_1))
        ...
        self.led_tw_2.setText(str(self.tw_2))
...
# ------------------------------------------------------------------------------
    def eventFilter(self, source: QtCore.QObject, event: QEvent) -> bool:
        ...
        led_f1 and 2, t1 / t2 and tw_1 / tw_2.
