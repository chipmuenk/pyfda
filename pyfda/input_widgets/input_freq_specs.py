...
#            else:
                ...
                if str(self.qlineedit[i].objectName()) != new_labels[i]:
                    ...
                    self.qlineedit[i].editingFinished.connect(self.store_entries, emit_sig = True)
...
#-------------------------------------------------------------
    def _store_entries(self):
        """
        _store_entries is called when a lineedit field has been edited
        
        It calls store_entries to sort and store the frequency specs, in 
        addition it also emits the sigSpecsChanged signal to trigger updates
        in higher hierarchies.
        """
        self.store_entries()
...
#-------------------------------------------------------------
    def store_entries(self, emit_sig = False):
        ...
        * a lineedit field has been edited (from _store_entries())
        ...
        * Store _normalized_ specification entries in filter dictionary:
        ...
        generated by input_filter. If needed, emit_sig can be set to True.
        """
