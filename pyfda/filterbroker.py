...
fil_init = {'rt':'LP', 'ft':'FIR', 'fc':'equiripple', 'fo':'man',
            ...
            'fxqc':
                {'QI':{'WI':0, 'WF':15, 'W':16, 'ovfl':'sat',  'quant':'round'},
                 ...
                 'QC':{'WI':0, 'WF':15, 'W':16, 'ovfl':'wrap', 'quant':'floor', 'scale':1<<16},
                 'QCB':{'WI':1, 'WF':14, 'W':16, 'ovfl':'wrap', 'quant':'floor', 'scale':1<<16},
                 'QCA':{'WI':2, 'WF':13, 'W':16, 'ovfl':'wrap', 'quant':'floor', 'scale':1<<16},
                 'b': [32768, 32768, 32768], 
                 'a': [65536, 6553, 0]
                 },
