...
class FilterCoeffsTest(unittest.TestCase):
    ...
    def initialize_form(self):
        ...
        self.set_cmb_box(self.ui.cmb_disp_frmt, 'Float')
    ...
    def initialize_fixpoint_format(self):
        self.set_cmb_box(self.ui.cmb_disp_frmt, 'Dec')
...
# ==============================================================================
    def test_defaults(self):
        ...
        self.assertEqual(qget_cmb_box(self.ui.cmb_disp_frmt, data=False).lower(), "float")
...
# ==============================================================================
    def test_fixpoint_defaults(self):
        ...
        self.assertEqual(qget_cmb_box(self.ui.cmb_disp_frmt, data=False).lower(), "dec")
