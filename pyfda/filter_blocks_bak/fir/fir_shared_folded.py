...
"""
Define folded FIR filter with a shared multiplier. This requires symmetric 
coefficients, resulting in a linear phase filter.
"""
...
def filter_fir_shared_folded(clock, reset, x, y, b):
    """Folded FIR filter with shared multiplier.
