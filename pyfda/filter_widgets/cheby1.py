...
class Cheby1():
    ...
    **Design routines:**
    ...
    def lp_min(self) -> int:
        ...
        self._get_params()
        self.N, self.f_pb_c = cheb1ord(
            self.f_pb, self.f_sb, self.a_pb, self.a_sb, analog=self.analog)
        return self._save(
            cheby1(self.N, self.a_pb, self.f_pb_c, btype='low',
    ...
    def hp_min(self) -> int:
        ...
        self.N, self.f_pb_c = cheb1ord(
            self.f_pb,self.f_sb, self.a_pb, self.a_sb, analog=self.analog)
        return self._save(
            cheby1(self.N, self.a_pb, self.f_pb_c, btype='highpass',
                   analog=self.analog, output=self.FRMT))
    ...
    def bp_min(self) -> int:
        ...
        self.N, self.f_pb_c = cheb1ord(
            ...
            analog=self.analog)
        return self._save(
            cheby1(self.N, self.a_pb, self.f_pb_c, btype='bandpass',
                   analog=self.analog, output=self.FRMT))
    ...
    def bs_min(self) -> int:
        ...
        self.N, self.f_pb_c = cheb1ord(
            ...
            analog = self.analog)
        return self._save(
            cheby1(self.N, self.a_pb, self.f_pb_c, btype='bandstop',
                   analog=self.analog, output=self.FRMT))
