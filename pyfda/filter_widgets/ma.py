...
#        self.info_doc.append(remezord.__doc__)
    ...
    def _construct_ui(self) -> None:
        ...
        self.lay_h_win.addWidget(self.lbl_delays)
        self.lay_h_win.addWidget(self.led_delays)
        self.lay_h_win.addStretch(1)
        self.lay_h_win.addWidget(self.lbl_stages)
        self.lay_h_win.addWidget(self.led_stages)
        self.lay_h_win.addStretch(1)
        self.lay_h_win.addWidget(self.chk_norm)
