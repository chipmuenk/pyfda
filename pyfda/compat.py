...
try:
    ...
    from PyQt5.QtCore import pyqtSignal, Qt, QEvent, QT_VERSION_STR, QSize, QSysInfo, QObject
    ...
    from PyQt4.QtCore import pyqtSignal, Qt, QEvent, QT_VERSION_STR, QSize, QSysInfo, QObject
