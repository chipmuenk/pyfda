...
Design butterworth-Filters (LP, HP, BP, BS) with fixed or minimum order, return
...
#            print("F_PBC vor", self.F_PBC, type(self.F_PBC))
    ...
    def LPman(self, specs):
        ...
        self.save(specs, sig.butter(self.N, self.F_PB,
    ...
    def LPmin(self, specs):
        ...
        self.save(specs, sig.butter(self.N, self.F_PBC,
                            btype='low', analog = False, output = frmt))
#
...
#                             analog=False, ftype='butter', output=frmt))
    ...
    def BPman(self, specs):
        self.get_params(specs)
        self.save(specs, sig.butter(self.N, [self.F_PB,self.F_PB2],
